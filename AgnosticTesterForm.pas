...
type
  TAgnosticTesterForm  = class(TForm)
...
var
  FAgnosticTesterForm: TAgnosticTesterForm;
...
function TAgnosticTesterForm .ArrayStringTest(const MethodName : String) : String;
var
...
function TAgnosticTesterForm .ArrayVariantTest(const MethodName : String) : String;
var
...
procedure TAgnosticTesterForm .Button1Click(Sender: TObject);
var
  Array1 : TArrayAssoc;
  Query: TQueryBuilder;
//  SQL: TQuery;
...
function TAgnosticTesterForm .ArrayFieldTest(const MethodName : String) : String;
var
...
procedure TAgnosticTesterForm .EditKeyDownFloatKeyDown(Sender: TObject; var Key: Word; var KeyChar: Char; Shift: TShiftState);
begin
  //TEdit(Sender).SetMaskFloatKeyDown(KeyChar, Key);
end;

procedure TAgnosticTesterForm .EditKeyDownMoneyKeyDown(Sender: TObject; var Key: Word; var KeyChar: Char; Shift: TShiftState);
begin
  //TEdit(Sender).SetMaskMoneyKeyDown(KeyChar, Key);
end;

procedure TAgnosticTesterForm .ComboBoxDataTypeTArrayStringChange(Sender: TObject);
var
  Value : String;
begin
...
procedure TAgnosticTesterForm .ComboBoxDataTypeTArrayVariantChange(Sender: TObject);
var
  Value : String;
begin
  Value := TComboBox(Sender).Selected.Text;
...
procedure TAgnosticTesterForm .ComboBoxDataTypeTArrayFieldChange(Sender: TObject);
var
  Value : String;
begin
  Value := TComboBox(Sender).Selected.Text;
...
procedure TAgnosticTesterForm .CalculateClick(Sender: TObject);
begin
...
procedure TAgnosticTesterForm .FormatExplicitClick(Sender: TObject);
begin
...
procedure TAgnosticTesterForm .FormatImplicitClick(Sender: TObject);
begin
  MemoResultFormat.Lines.Clear;
...
procedure TAgnosticTesterForm .FormShow(Sender: TObject);
begin
  EditKeyDownMoney.Placeholder('Máscara Monetária');
  EditKeyDownFloat.Placeholder('Máscara Decimal[4]');
end;

procedure TAgnosticTesterForm .TabDBFirebirdClick(Sender: TObject);
var
  ...
  try
    ...
    try
      ...
      try
        ...
        Connector.ToCombo(ComboBoxFirebird, 'Codigo', 'Estado', TDictionaryHelper<String, TArray<Variant>>.Make(['Index'], [[0]]));
        Connector.ToCombo(EditFirebird, 'Codigo', 'Estado', TDictionaryHelper<String, TArray<Variant>>.Make(['Column'], [['Estado', 'Rio Grande do Norte']]));
        Connector.ToCombo(ComboEditFirebird, 'Codigo', 'Estado', TDictionaryHelper<String, TArray<Variant>>.Make(['Column'], [['Codigo', 4]]));
        Connector.ToListBox(ListBoxFirebird, 'Codigo', 'Estado', TDictionaryHelper<String, TArray<Variant>>.Make(['Column'], [['Codigo', 20]]));
...
procedure TAgnosticTesterForm .TabDBMySQLClick(Sender: TObject);
var
  DBMySQL : TConnection;
  SQL: TQuery;
  Query: TQueryBuilder;
  ...
  try
    ...
    try
      ...
      try
        ...
        Connector.ToCombo(ComboBoxMySQL, 'Codigo', 'Estado', TDictionaryHelper<String, TArray<Variant>>.Make(['Index'], [[0]]));
        Connector.ToCombo(EditMySQL, 'Codigo', 'Estado', TDictionaryHelper<String, TArray<Variant>>.Make(['Column'], [['Estado', 'Rio Grande do Norte']]));
        Connector.ToCombo(ComboEditMySQL, 'Codigo', 'Estado', TDictionaryHelper<String, TArray<Variant>>.Make(['Column'], [['Codigo', 4]]));
        Connector.ToListBox(ListBoxMySQL, 'Codigo', 'Estado', TDictionaryHelper<String, TArray<Variant>>.Make(['Column'], [['Codigo', 20]]));
...
procedure TAgnosticTesterForm .TabDBPostgreSQLClick(Sender: TObject);
var
  ...
  try
    ...
    try
      ...
      try
        ...
        Connector.ToCombo(ComboBoxPostgreSQL, 'Codigo', 'Estado', TDictionaryHelper<String, TArray<Variant>>.Make(['Index'], [[0]]));
        Connector.ToCombo(EditPostgreSQL, 'Codigo', 'Estado', TDictionaryHelper<String, TArray<Variant>>.Make(['Column'], [['Estado', 'Rio Grande do Norte']]));
        Connector.ToCombo(ComboEditPostgreSQL, 'Codigo', 'Estado', TDictionaryHelper<String, TArray<Variant>>.Make(['Column'], [['Codigo', 4]]));
        Connector.ToListBox(ListBoxPostgreSQL, 'Codigo', 'Estado', TDictionaryHelper<String, TArray<Variant>>.Make(['Column'], [['Codigo', 20]]));
...
procedure TAgnosticTesterForm .TabDBSQLiteClick(Sender: TObject);
var
  ...
  try
    ...
    try
      ...
      try
        ...
        Connector.ToCombo(ComboBoxSQLite, 'Codigo', 'Estado', TDictionaryHelper<String, TArray<Variant>>.Make(['Index'], [[0]]));
        Connector.ToCombo(EditSQLite, 'Codigo', 'Estado', TDictionaryHelper<String, TArray<Variant>>.Make(['Column'], [['Estado', 'Rio Grande do Norte']]));
        Connector.ToCombo(ComboEditSQLite, 'Codigo', 'Estado', TDictionaryHelper<String, TArray<Variant>>.Make(['Column'], [['Codigo', 4]]));
        Connector.ToListBox(ListBoxSQLite, 'Codigo', 'Estado', TDictionaryHelper<String, TArray<Variant>>.Make(['Column'], [['Codigo', 20]]));
