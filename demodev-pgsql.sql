...
-- Started on 2019-04-16 10:46:08
...
ALTER ROLE postgres WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'md5e005dad5696d79aa98727e39dc30b66e';
...
CREATE DATABASE demodev WITH TEMPLATE = template0 OWNER = postgres;
...
-- Completed on 2019-04-16 10:46:08
...
-- Started on 2019-04-16 10:46:09
...
--
-- TOC entry 2322 (class 1262 OID 12373)
-- Dependencies: 2321
...
--
-- TOC entry 9 (class 2615 OID 33173)
-- Name: demodev; Type: SCHEMA; Schema: -; Owner: postgres
--

CREATE SCHEMA demodev;


ALTER SCHEMA demodev OWNER TO postgres;
...
SET search_path = demodev, pg_catalog;
...
--
-- TOC entry 184 (class 1259 OID 33176)
-- Name: arquivo; Type: TABLE; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 183 (class 1259 OID 33174)
-- Name: arquivo_id_seq; Type: SEQUENCE; Schema: demodev; Owner: postgres
--
...
ALTER TABLE arquivo_id_seq OWNER TO postgres;

--
-- TOC entry 2327 (class 0 OID 0)
-- Dependencies: 183
-- Name: arquivo_id_seq; Type: SEQUENCE OWNED BY; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 186 (class 1259 OID 33184)
-- Name: card; Type: TABLE; Schema: demodev; Owner: postgres
--
...
CREATE TABLE card (
    ...
    tempo_utilizado time without time zone,
    tempo_restante time without time zone,
    titulo character varying(255),
    descricao text,
    status character varying(255) DEFAULT 'EM ESPERA'::character varying,
    prioridade character varying(255) DEFAULT 'NORMAL'::character varying,
    ordem integer DEFAULT 0,
    tema character varying(255) DEFAULT 'DEFAULT'::character varying,
    categoria character varying(255) DEFAULT 'TASK'::character varying,
...
--
-- TOC entry 188 (class 1259 OID 33200)
-- Name: card_activity; Type: TABLE; Schema: demodev; Owner: postgres
--

CREATE TABLE card_activity (
    id integer NOT NULL,
    card_id integer,
    datahora_comeco timestamp without time zone,
    datahora_parada timestamp without time zone,
    notas text,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    deleted_at timestamp without time zone
...
ALTER TABLE card_activity OWNER TO postgres;

--
-- TOC entry 187 (class 1259 OID 33198)
-- Name: card_activity_id_seq; Type: SEQUENCE; Schema: demodev; Owner: postgres
--

CREATE SEQUENCE card_activity_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE card_activity_id_seq OWNER TO postgres;

--
-- TOC entry 2328 (class 0 OID 0)
-- Dependencies: 187
-- Name: card_activity_id_seq; Type: SEQUENCE OWNED BY; Schema: demodev; Owner: postgres
--

ALTER SEQUENCE card_activity_id_seq OWNED BY card_activity.id;


--
-- TOC entry 185 (class 1259 OID 33182)
-- Name: card_id_seq; Type: SEQUENCE; Schema: demodev; Owner: postgres
--
...
-- Dependencies: 185
-- Name: card_id_seq; Type: SEQUENCE OWNED BY; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 190 (class 1259 OID 33211)
-- Name: card_scrum; Type: TABLE; Schema: demodev; Owner: postgres
--

CREATE TABLE card_scrum (
    id integer NOT NULL,
    card_id integer,
    ...
    thirteen boolean DEFAULT false,
    twenty boolean DEFAULT false,
    forty boolean DEFAULT false,
    hundred boolean DEFAULT false,
    undetermined boolean DEFAULT false,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    deleted_at timestamp without time zone
);
...
ALTER TABLE card_scrum OWNER TO postgres;

--
-- TOC entry 189 (class 1259 OID 33209)
-- Name: card_scrum_id_seq; Type: SEQUENCE; Schema: demodev; Owner: postgres
--

CREATE SEQUENCE card_scrum_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE card_scrum_id_seq OWNER TO postgres;

--
-- TOC entry 2330 (class 0 OID 0)
-- Dependencies: 189
-- Name: card_scrum_id_seq; Type: SEQUENCE OWNED BY; Schema: demodev; Owner: postgres
--

ALTER SEQUENCE card_scrum_id_seq OWNED BY card_scrum.id;


--
-- TOC entry 192 (class 1259 OID 33232)
-- Name: card_sector; Type: TABLE; Schema: demodev; Owner: postgres
--

CREATE TABLE card_sector (
    id integer NOT NULL,
    nome character varying(255),
...
ALTER TABLE card_sector OWNER TO postgres;

--
-- TOC entry 191 (class 1259 OID 33230)
-- Name: card_sector_id_seq; Type: SEQUENCE; Schema: demodev; Owner: postgres
--

CREATE SEQUENCE card_sector_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE card_sector_id_seq OWNER TO postgres;

--
-- TOC entry 2331 (class 0 OID 0)
-- Dependencies: 191
-- Name: card_sector_id_seq; Type: SEQUENCE OWNED BY; Schema: demodev; Owner: postgres
--

ALTER SEQUENCE card_sector_id_seq OWNED BY card_sector.id;


--
-- TOC entry 194 (class 1259 OID 33240)
-- Name: cidade; Type: TABLE; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 193 (class 1259 OID 33238)
-- Name: cidade_id_seq; Type: SEQUENCE; Schema: demodev; Owner: postgres
--
...
-- Dependencies: 193
-- Name: cidade_id_seq; Type: SEQUENCE OWNED BY; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 196 (class 1259 OID 33248)
-- Name: configuracao; Type: TABLE; Schema: demodev; Owner: postgres
--
...
CREATE TABLE configuracao (
    ...
    avisos_sonoros boolean DEFAULT true,
    notificacoes_desktop boolean DEFAULT true,
    alertas_voz boolean DEFAULT true,
    atalhos_teclado boolean DEFAULT true,
...
--
-- TOC entry 195 (class 1259 OID 33246)
-- Name: configuracao_id_seq; Type: SEQUENCE; Schema: demodev; Owner: postgres
--
...
-- Dependencies: 195
-- Name: configuracao_id_seq; Type: SEQUENCE OWNED BY; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 198 (class 1259 OID 33263)
-- Name: endereco; Type: TABLE; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 197 (class 1259 OID 33261)
-- Name: endereco_id_seq; Type: SEQUENCE; Schema: demodev; Owner: postgres
--
...
-- Dependencies: 197
-- Name: endereco_id_seq; Type: SEQUENCE OWNED BY; Schema: demodev; Owner: postgres
--
...
-- Name: estado; Type: TABLE; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 199 (class 1259 OID 33272)
-- Name: estado_id_seq; Type: SEQUENCE; Schema: demodev; Owner: postgres
--
...
-- Dependencies: 199
-- Name: estado_id_seq; Type: SEQUENCE OWNED BY; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 202 (class 1259 OID 33282)
-- Name: kanban; Type: TABLE; Schema: demodev; Owner: postgres
--
...
ALTER TABLE kanban OWNER TO postgres;

--
-- TOC entry 201 (class 1259 OID 33280)
-- Name: kanban_id_seq; Type: SEQUENCE; Schema: demodev; Owner: postgres
--

CREATE SEQUENCE kanban_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE kanban_id_seq OWNER TO postgres;

--
-- TOC entry 2336 (class 0 OID 0)
-- Dependencies: 201
-- Name: kanban_id_seq; Type: SEQUENCE OWNED BY; Schema: demodev; Owner: postgres
--

ALTER SEQUENCE kanban_id_seq OWNED BY kanban.id;


--
-- TOC entry 204 (class 1259 OID 33295)
-- Name: logradouro; Type: TABLE; Schema: demodev; Owner: postgres
--
...
ALTER TABLE logradouro OWNER TO postgres;

--
-- TOC entry 203 (class 1259 OID 33293)
-- Name: logradouro_id_seq; Type: SEQUENCE; Schema: demodev; Owner: postgres
--
...
ALTER TABLE logradouro_id_seq OWNER TO postgres;

--
-- TOC entry 2337 (class 0 OID 0)
-- Dependencies: 203
-- Name: logradouro_id_seq; Type: SEQUENCE OWNED BY; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 206 (class 1259 OID 33303)
-- Name: perfil; Type: TABLE; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 205 (class 1259 OID 33301)
-- Name: perfil_id_seq; Type: SEQUENCE; Schema: demodev; Owner: postgres
--
...
-- Dependencies: 205
-- Name: perfil_id_seq; Type: SEQUENCE OWNED BY; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 207 (class 1259 OID 33312)
-- Name: sessions; Type: TABLE; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 209 (class 1259 OID 33322)
-- Name: sprint; Type: TABLE; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 208 (class 1259 OID 33320)
-- Name: sprint_id_seq; Type: SEQUENCE; Schema: demodev; Owner: postgres
--
...
-- Dependencies: 208
-- Name: sprint_id_seq; Type: SEQUENCE OWNED BY; Schema: demodev; Owner: postgres
--
...
-- Name: usuario; Type: TABLE; Schema: demodev; Owner: postgres
--
...
CREATE TABLE usuario (
    ...
    raw character varying(128),
    email character varying(255),
    perfil_id integer,
    logado boolean DEFAULT false,
    contagem integer DEFAULT 0,
    atual_ip character varying(15),
    ultimo_ip character varying(15),
    ultimo_acesso timestamp without time zone,
    arquivo_id integer,
    usuario_dados_id integer,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    deleted_at timestamp without time zone
);
...
-- Name: usuario_dados; Type: TABLE; Schema: demodev; Owner: postgres
--
...
ALTER TABLE usuario_dados OWNER TO postgres;

--
-- TOC entry 212 (class 1259 OID 33345)
-- Name: usuario_dados_id_seq; Type: SEQUENCE; Schema: demodev; Owner: postgres
--

CREATE SEQUENCE usuario_dados_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE usuario_dados_id_seq OWNER TO postgres;

--
-- TOC entry 2340 (class 0 OID 0)
-- Dependencies: 212
-- Name: usuario_dados_id_seq; Type: SEQUENCE OWNED BY; Schema: demodev; Owner: postgres
--

ALTER SEQUENCE usuario_dados_id_seq OWNED BY usuario_dados.id;


--
-- TOC entry 210 (class 1259 OID 33330)
-- Name: usuario_id_seq; Type: SEQUENCE; Schema: demodev; Owner: postgres
--
...
-- Dependencies: 210
-- Name: usuario_id_seq; Type: SEQUENCE OWNED BY; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2080 (class 2604 OID 33179)
-- Name: id; Type: DEFAULT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2081 (class 2604 OID 33187)
-- Name: id; Type: DEFAULT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2087 (class 2604 OID 33203)
-- Name: id; Type: DEFAULT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY card_activity ALTER COLUMN id SET DEFAULT nextval('card_activity_id_seq'::regclass);


--
-- TOC entry 2088 (class 2604 OID 33214)
-- Name: id; Type: DEFAULT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY card_scrum ALTER COLUMN id SET DEFAULT nextval('card_scrum_id_seq'::regclass);


--
-- TOC entry 2102 (class 2604 OID 33235)
-- Name: id; Type: DEFAULT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY card_sector ALTER COLUMN id SET DEFAULT nextval('card_sector_id_seq'::regclass);


--
-- TOC entry 2103 (class 2604 OID 33243)
-- Name: id; Type: DEFAULT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2104 (class 2604 OID 33251)
-- Name: id; Type: DEFAULT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2109 (class 2604 OID 33266)
-- Name: id; Type: DEFAULT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2110 (class 2604 OID 33277)
-- Name: id; Type: DEFAULT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2111 (class 2604 OID 33285)
-- Name: id; Type: DEFAULT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY kanban ALTER COLUMN id SET DEFAULT nextval('kanban_id_seq'::regclass);


--
-- TOC entry 2114 (class 2604 OID 33298)
-- Name: id; Type: DEFAULT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2115 (class 2604 OID 33306)
-- Name: id; Type: DEFAULT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2116 (class 2604 OID 33325)
-- Name: id; Type: DEFAULT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2119 (class 2604 OID 33335)
-- Name: id; Type: DEFAULT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2122 (class 2604 OID 33350)
-- Name: id; Type: DEFAULT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY usuario_dados ALTER COLUMN id SET DEFAULT nextval('usuario_dados_id_seq'::regclass);


--
-- TOC entry 2287 (class 0 OID 33176)
-- Dependencies: 184
-- Data for Name: arquivo; Type: TABLE DATA; Schema: demodev; Owner: postgres
--

COPY arquivo (id, nome, created_at, updated_at) FROM stdin;
\.
...
-- Dependencies: 183
-- Name: arquivo_id_seq; Type: SEQUENCE SET; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2289 (class 0 OID 33184)
-- Dependencies: 186
-- Data for Name: card; Type: TABLE DATA; Schema: demodev; Owner: postgres
--

COPY card (id, kanban_id, sector_id, usuario_id, tempo_estimado, tempo_utilizado, tempo_restante, titulo, descricao, status, prioridade, ordem, tema, categoria, completed_at, created_at, updated_at, deleted_at) FROM stdin;
\.


--
-- TOC entry 2291 (class 0 OID 33200)
-- Dependencies: 188
-- Data for Name: card_activity; Type: TABLE DATA; Schema: demodev; Owner: postgres
--

COPY card_activity (id, card_id, datahora_comeco, datahora_parada, notas, created_at, updated_at, deleted_at) FROM stdin;
\.
...
-- Dependencies: 187
-- Name: card_activity_id_seq; Type: SEQUENCE SET; Schema: demodev; Owner: postgres
--

SELECT pg_catalog.setval('card_activity_id_seq', 1, false);


--
-- TOC entry 2344 (class 0 OID 0)
-- Dependencies: 185
-- Name: card_id_seq; Type: SEQUENCE SET; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2293 (class 0 OID 33211)
-- Dependencies: 190
-- Data for Name: card_scrum; Type: TABLE DATA; Schema: demodev; Owner: postgres
--

COPY card_scrum (id, card_id, undefined, zero, half, one, two, three, five, eight, thirteen, twenty, forty, hundred, undetermined, created_at, updated_at, deleted_at) FROM stdin;
\.
...
-- Dependencies: 189
-- Name: card_scrum_id_seq; Type: SEQUENCE SET; Schema: demodev; Owner: postgres
--

SELECT pg_catalog.setval('card_scrum_id_seq', 1, false);


--
-- TOC entry 2295 (class 0 OID 33232)
-- Dependencies: 192
-- Data for Name: card_sector; Type: TABLE DATA; Schema: demodev; Owner: postgres
--

COPY card_sector (id, nome, icone, created_at, updated_at, deleted_at) FROM stdin;
1	Back-end	eye-close	2016-12-02 10:30:37	2016-12-02 10:30:37	\N
2	Front-end	eye-open	2016-12-02 10:30:37	2016-12-02 10:30:37	\N
3	Design	picture	2016-12-02 10:30:37	2016-12-02 10:30:37	\N
4	Documentação	book	2016-12-02 10:30:37	2016-12-02 10:30:37	\N
\.
...
-- Dependencies: 191
-- Name: card_sector_id_seq; Type: SEQUENCE SET; Schema: demodev; Owner: postgres
--

SELECT pg_catalog.setval('card_sector_id_seq', 4, true);


--
-- TOC entry 2297 (class 0 OID 33240)
-- Dependencies: 194
-- Data for Name: cidade; Type: TABLE DATA; Schema: demodev; Owner: postgres
--
...
-- Dependencies: 193
-- Name: cidade_id_seq; Type: SEQUENCE SET; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2299 (class 0 OID 33248)
-- Dependencies: 196
-- Data for Name: configuracao; Type: TABLE DATA; Schema: demodev; Owner: postgres
--

COPY configuracao (id, usuario_id, assinatura_email, avisos_sonoros, notificacoes_desktop, alertas_voz, atalhos_teclado, campos_customizados, created_at, updated_at, deleted_at) FROM stdin;
\.
...
-- Dependencies: 195
-- Name: configuracao_id_seq; Type: SEQUENCE SET; Schema: demodev; Owner: postgres
--

SELECT pg_catalog.setval('configuracao_id_seq', 1, false);


--
-- TOC entry 2301 (class 0 OID 33263)
-- Dependencies: 198
-- Data for Name: endereco; Type: TABLE DATA; Schema: demodev; Owner: postgres
--

COPY endereco (id, cep, logradouro_id, endereco, bairro, complemento, numero, cidade_id, ponto_referencia, coordenadas, created_at, updated_at, deleted_at) FROM stdin;
1	\N	4	Alberto Maranhão	Centro	\N	\N	3769	\N	\N	2016-12-02 10:30:37	2016-12-02 10:30:37	\N
\.
...
-- Dependencies: 197
-- Name: endereco_id_seq; Type: SEQUENCE SET; Schema: demodev; Owner: postgres
--

SELECT pg_catalog.setval('endereco_id_seq', 1, true);


--
-- TOC entry 2303 (class 0 OID 33274)
-- Dependencies: 200
-- Data for Name: estado; Type: TABLE DATA; Schema: demodev; Owner: postgres
--
...
-- Dependencies: 199
-- Name: estado_id_seq; Type: SEQUENCE SET; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2305 (class 0 OID 33282)
-- Dependencies: 202
-- Data for Name: kanban; Type: TABLE DATA; Schema: demodev; Owner: postgres
--

COPY kanban (id, sprint_id, nome, tema, created_at, updated_at, deleted_at) FROM stdin;
\.
...
-- Dependencies: 201
-- Name: kanban_id_seq; Type: SEQUENCE SET; Schema: demodev; Owner: postgres
--

SELECT pg_catalog.setval('kanban_id_seq', 1, false);


--
-- TOC entry 2307 (class 0 OID 33295)
-- Dependencies: 204
-- Data for Name: logradouro; Type: TABLE DATA; Schema: demodev; Owner: postgres
--

COPY logradouro (id, nome) FROM stdin;
1	Outros
2	Aeroporto
3	Área
4	Avenida
...
-- Dependencies: 203
-- Name: logradouro_id_seq; Type: SEQUENCE SET; Schema: demodev; Owner: postgres
--

SELECT pg_catalog.setval('logradouro_id_seq', 44, true);


--
-- TOC entry 2309 (class 0 OID 33303)
-- Dependencies: 206
-- Data for Name: perfil; Type: TABLE DATA; Schema: demodev; Owner: postgres
--

COPY perfil (id, nome, permissoes, created_at, updated_at, deleted_at) FROM stdin;
1	Administrador	a:1:{s:8:"Carregar";s:4:"Tudo";}	2016-12-02 10:30:37	2016-12-02 10:30:37	\N
\.
...
-- Dependencies: 205
-- Name: perfil_id_seq; Type: SEQUENCE SET; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2310 (class 0 OID 33312)
-- Dependencies: 207
-- Data for Name: sessions; Type: TABLE DATA; Schema: demodev; Owner: postgres
--

COPY sessions (id, last_activity, expiration, data) FROM stdin;
p2krn1b6u54b71teujeulscum4	1480698405	1481303205	
\.


--
-- TOC entry 2312 (class 0 OID 33322)
-- Dependencies: 209
-- Data for Name: sprint; Type: TABLE DATA; Schema: demodev; Owner: postgres
--

COPY sprint (id, nome, colunas, status, data_inicio, data_fim, created_at, updated_at, deleted_at) FROM stdin;
\.
...
-- Dependencies: 208
-- Name: sprint_id_seq; Type: SEQUENCE SET; Schema: demodev; Owner: postgres
--

SELECT pg_catalog.setval('sprint_id_seq', 1, false);


--
-- TOC entry 2314 (class 0 OID 33332)
-- Dependencies: 211
-- Data for Name: usuario; Type: TABLE DATA; Schema: demodev; Owner: postgres
--

COPY usuario (id, apelido, login, senha, hash, raw, email, perfil_id, logado, contagem, atual_ip, ultimo_ip, ultimo_acesso, arquivo_id, usuario_dados_id, created_at, updated_at, deleted_at) FROM stdin;
1	Administrador	admin@demo.com	21232f297a57a5a743894a0e4a801fc3	c7ad44cbad762a5da0a452f9e854fdc1e0e7a52a38015f23f3eab1d80b931dd472634dfac71cd34ebc35d16ab7fb8a90c81f975113d6c7538dc69dd8de9077ec	NjE2NDZkNjk2ZQ==	recover@demo.com	1	f	0	\N	\N	\N	\N	1	2016-12-02 10:30:37	2016-12-02 10:30:37	\N
\.


--
-- TOC entry 2316 (class 0 OID 33347)
-- Dependencies: 213
-- Data for Name: usuario_dados; Type: TABLE DATA; Schema: demodev; Owner: postgres
--

COPY usuario_dados (id, nome, cpf, rg, emails, telefones, data_nascimento, estado_civil, profissao, genero, naturalidade_id, filiacao, observacao, endereco_id, created_at, updated_at, deleted_at) FROM stdin;
1	Administrador	012.345.678-90	\N	admin@gmail.com	\N	\N	Casado(a)	Analista de Sistemas	Masculino	3769	\N	N/A|NIHIL	1	2016-12-02 10:30:37	2016-12-02 10:30:37	\N
\.
...
-- Dependencies: 212
-- Name: usuario_dados_id_seq; Type: SEQUENCE SET; Schema: demodev; Owner: postgres
--

SELECT pg_catalog.setval('usuario_dados_id_seq', 1, true);


--
-- TOC entry 2356 (class 0 OID 0)
-- Dependencies: 210
-- Name: usuario_id_seq; Type: SEQUENCE SET; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2124 (class 2606 OID 33181)
-- Name: arquivo_pkey; Type: CONSTRAINT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2128 (class 2606 OID 33208)
-- Name: card_activity_pkey; Type: CONSTRAINT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2126 (class 2606 OID 33197)
-- Name: card_pkey; Type: CONSTRAINT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2130 (class 2606 OID 33229)
-- Name: card_scrum_pkey; Type: CONSTRAINT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY card_scrum
    ADD CONSTRAINT card_scrum_pkey PRIMARY KEY (id);


--
-- TOC entry 2132 (class 2606 OID 33237)
-- Name: card_sector_pkey; Type: CONSTRAINT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY card_sector
    ADD CONSTRAINT card_sector_pkey PRIMARY KEY (id);


--
-- TOC entry 2134 (class 2606 OID 33245)
-- Name: cidade_pkey; Type: CONSTRAINT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2136 (class 2606 OID 33260)
-- Name: configuracao_pkey; Type: CONSTRAINT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2138 (class 2606 OID 33271)
-- Name: endereco_pkey; Type: CONSTRAINT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2140 (class 2606 OID 33279)
-- Name: estado_pkey; Type: CONSTRAINT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2142 (class 2606 OID 33292)
-- Name: kanban_pkey; Type: CONSTRAINT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2144 (class 2606 OID 33300)
-- Name: logradouro_pkey; Type: CONSTRAINT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2146 (class 2606 OID 33311)
-- Name: perfil_pkey; Type: CONSTRAINT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2148 (class 2606 OID 33319)
-- Name: sessions_pkey; Type: CONSTRAINT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2150 (class 2606 OID 33329)
-- Name: sprint_pkey; Type: CONSTRAINT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2156 (class 2606 OID 33355)
-- Name: usuario_dados_pkey; Type: CONSTRAINT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY usuario_dados
    ADD CONSTRAINT usuario_dados_pkey PRIMARY KEY (id);


--
-- TOC entry 2152 (class 2606 OID 33344)
-- Name: usuario_email_key; Type: CONSTRAINT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2154 (class 2606 OID 33342)
-- Name: usuario_pkey; Type: CONSTRAINT; Schema: demodev; Owner: postgres
--
...
--
-- TOC entry 2160 (class 2606 OID 33371)
-- Name: demodev_card_activity_card_id_demodev_card_id; Type: FK CONSTRAINT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY card_activity
    ADD CONSTRAINT demodev_card_activity_card_id_demodev_card_id FOREIGN KEY (card_id) REFERENCES card(id);


--
-- TOC entry 2159 (class 2606 OID 33366)
-- Name: demodev_card_kanban_id_demodev_kanban_id; Type: FK CONSTRAINT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY card
    ADD CONSTRAINT demodev_card_kanban_id_demodev_kanban_id FOREIGN KEY (kanban_id) REFERENCES kanban(id);


--
-- TOC entry 2161 (class 2606 OID 33376)
-- Name: demodev_card_scrum_card_id_demodev_card_id; Type: FK CONSTRAINT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY card_scrum
    ADD CONSTRAINT demodev_card_scrum_card_id_demodev_card_id FOREIGN KEY (card_id) REFERENCES card(id);


--
-- TOC entry 2158 (class 2606 OID 33361)
-- Name: demodev_card_sector_id_demodev_card_sector_id; Type: FK CONSTRAINT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY card
    ADD CONSTRAINT demodev_card_sector_id_demodev_card_sector_id FOREIGN KEY (sector_id) REFERENCES card_sector(id);


--
-- TOC entry 2157 (class 2606 OID 33356)
-- Name: demodev_card_usuario_id_demodev_usuario_id; Type: FK CONSTRAINT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY card
    ADD CONSTRAINT demodev_card_usuario_id_demodev_usuario_id FOREIGN KEY (usuario_id) REFERENCES usuario(id);


--
-- TOC entry 2162 (class 2606 OID 33381)
-- Name: demodev_cidade_estado_id_demodev_estado_id; Type: FK CONSTRAINT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY cidade
    ADD CONSTRAINT demodev_cidade_estado_id_demodev_estado_id FOREIGN KEY (estado_id) REFERENCES estado(id);


--
-- TOC entry 2163 (class 2606 OID 33386)
-- Name: demodev_configuracao_usuario_id_demodev_usuario_id; Type: FK CONSTRAINT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY configuracao
    ADD CONSTRAINT demodev_configuracao_usuario_id_demodev_usuario_id FOREIGN KEY (usuario_id) REFERENCES usuario(id);


--
-- TOC entry 2165 (class 2606 OID 33396)
-- Name: demodev_endereco_cidade_id_demodev_cidade_id; Type: FK CONSTRAINT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY endereco
    ADD CONSTRAINT demodev_endereco_cidade_id_demodev_cidade_id FOREIGN KEY (cidade_id) REFERENCES cidade(id);


--
-- TOC entry 2164 (class 2606 OID 33391)
-- Name: demodev_endereco_logradouro_id_demodev_logradouro_id; Type: FK CONSTRAINT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY endereco
    ADD CONSTRAINT demodev_endereco_logradouro_id_demodev_logradouro_id FOREIGN KEY (logradouro_id) REFERENCES logradouro(id);


--
-- TOC entry 2166 (class 2606 OID 33401)
-- Name: demodev_kanban_sprint_id_demodev_sprint_id; Type: FK CONSTRAINT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY kanban
    ADD CONSTRAINT demodev_kanban_sprint_id_demodev_sprint_id FOREIGN KEY (sprint_id) REFERENCES sprint(id);


--
-- TOC entry 2169 (class 2606 OID 33416)
-- Name: demodev_usuario_arquivo_id_demodev_arquivo_id; Type: FK CONSTRAINT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY usuario
    ADD CONSTRAINT demodev_usuario_arquivo_id_demodev_arquivo_id FOREIGN KEY (arquivo_id) REFERENCES arquivo(id);


--
-- TOC entry 2171 (class 2606 OID 33426)
-- Name: demodev_usuario_dados_endereco_id_demodev_endereco_id; Type: FK CONSTRAINT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY usuario_dados
    ADD CONSTRAINT demodev_usuario_dados_endereco_id_demodev_endereco_id FOREIGN KEY (endereco_id) REFERENCES endereco(id);


--
-- TOC entry 2170 (class 2606 OID 33421)
-- Name: demodev_usuario_dados_naturalidade_id_demodev_cidade_id; Type: FK CONSTRAINT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY usuario_dados
    ADD CONSTRAINT demodev_usuario_dados_naturalidade_id_demodev_cidade_id FOREIGN KEY (naturalidade_id) REFERENCES cidade(id);


--
-- TOC entry 2168 (class 2606 OID 33411)
-- Name: demodev_usuario_perfil_id_demodev_perfil_id; Type: FK CONSTRAINT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY usuario
    ADD CONSTRAINT demodev_usuario_perfil_id_demodev_perfil_id FOREIGN KEY (perfil_id) REFERENCES perfil(id);


--
-- TOC entry 2167 (class 2606 OID 33406)
-- Name: demodev_usuario_usuario_dados_id_demodev_usuario_dados_id; Type: FK CONSTRAINT; Schema: demodev; Owner: postgres
--

ALTER TABLE ONLY usuario
    ADD CONSTRAINT demodev_usuario_usuario_dados_id_demodev_usuario_dados_id FOREIGN KEY (usuario_dados_id) REFERENCES usuario_dados(id);
...
-- Completed on 2019-04-16 10:46:09
...
-- Started on 2019-04-16 10:46:11
...
-- Completed on 2019-04-16 10:46:11

--
-- PostgreSQL database dump complete
--

-- Completed on 2019-04-16 10:46:12
