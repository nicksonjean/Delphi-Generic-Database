...
class function TArrayNativeHelper.Add<T>(var Values: TArray<T>; Item: T): integer;
begin
...
class function TArrayNativeHelper.IndexOf<T>(var Values: TArray<T>; Item: T): integer;
begin
...
class function TArrayNativeHelper.IndexOfMax<T>(var Values: TArray<T>; const Comparer: IComparer<T>): integer;
var
  I: Integer;
begin
...
class function TArrayNativeHelper.IndexOfMin<T>(var Values: TArray<T>): integer;
begin
  Result := IndexOfMin<T>(Values, TComparer<T>.Default);
end;

class function TArrayNativeHelper.IndexOfMin<T>(var Values: TArray<T>; const Comparer: IComparer<T>): integer;
var
  I: Integer;
begin
  if length(Values) = 0 then
...
class procedure TArrayNativeHelper.Test_All_Helper_Functions;
begin
  TestArrayNativeHelper;
  TestArrayContainer;
  Test_TestRecord;
end;
