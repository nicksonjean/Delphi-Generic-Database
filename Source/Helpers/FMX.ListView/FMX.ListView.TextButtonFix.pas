...
type
  TListViewTextButtonFix = record
    ...
    class procedure Rendering(const Sender: TObject; const AItem: TListViewItem;
      var AHandled: Boolean); static;
  end;
...
class procedure TListViewTextButtonFix.Rendering(const Sender: TObject;
...
begin
  ...
  ATextButton := AItem.Objects.FindObjectT<TListItemTextButton>('B');
  // default name for TextButton (do not localize)
  ...
  begin
    ...
    ATextButton.TextShadowOffset.Assign
      (AItem.Objects.TextButton.TextShadowOffset);
  end;
