...
uses
  System.Classes, System.Types, System.Threading, System.IOUtils,
...
var
  ...
  I: Integer;
begin
  System.Delete(FContent, 1, pos('<div class="ipsAreaBackground_light ipsPad">',
    FContent));
  ...
  begin
    ...
    begin
      ...
      aDel := '<img src=' + Parse('<img src=', 'itemprop="image">', FContent) +
        'itemprop="image">';
