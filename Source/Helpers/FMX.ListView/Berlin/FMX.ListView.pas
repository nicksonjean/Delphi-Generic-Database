...
type
  ...
  public
    ...
    property ShowFirstSeparator: Boolean read FShowFirstSeparator
      write SetShowFirstSeparator default True;
    property ShowLastSeparator: Boolean read FShowLastSeparator
      write SetShowLastSeparator default True;
    ...
    property TransparentHeaders: Boolean read FTransparentHeaders
      write SetTransparentHeader default False; // ZuBy
...
function TListViewBase.getItemTextButtonHeight(const AItem: TListItemTextButton;
...
function TListViewBase.getItemTextButtonWidth(const AItem: TListItemTextButton;
...
function TListViewBase.getItemTextHeight(const AItem: TListItemText;
const aWidth: Single = 0): Integer; // ZuBy
var
  aItemWidth: Single;
begin
...
function TListViewBase.getItemTextWidth(const AItem: TListItemText;
const aHeight: Single): Integer;
begin
  if AItem.Text.IsEmpty then
  begin
...
function TListViewBase.getTextSize(const aText: string; aFont: TFont;
